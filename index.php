...
$program=$about=$email=$phone=$body="";
$requirement="";
$data=array();
...
function maxcapacity($capacity,$currentcapacity,$id){
  if($capacity!=$currentcapacity)
     return '<a href="apply.php?id='.$id.'&currentcapacity='.$currentcapacity.'" class="btn-2">Join now</a>
  ';
  else return "";
}
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="internship_programs.php"> Upcoming Programs </a>
                </li>
                </li>
                <li class="nav-item">
                      ...
                      <div class="detail-box">
                       ...
                       '.$body.'
                        ...
                        <div class="btn-box">
                          ...
                          '.maxcapacity($data[0]["maxcapacity"],$data[0]["currentcapacity"],$data[0]["id"]).'
                          </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a href="program.php?iv='.$encodedIV.'&id='.$encodedData.'" class="btn-1"> More Details </a>
                      '.maxcapacity($data[$i]["maxcapacity"],$data[$i]["currentcapacity"],$data[$i]["id"]).'
                      </div>
                      </div>
                    </div>
                  </div>
